---
title: 'Figure 2: Spatiotemporal gradients in temporal stability and spatial heterogeneity'
...
In this script, we assemble the data for and generate the panels of Figure 2, which shows how temporal stability depends on latitude and temperature, and how spatial heterogeneity varies across latitudes and through time.
...
```{r}
# Make categories for latitudinal bins and age bins for the boxplots and stats
...
# Supplemental figure with boxplots comparing latitudinal categories within each time bin for the past 30 Myrs.
...
# Old version of figure before combining panels
...
## Results with a more conservative sampling threshold: 
